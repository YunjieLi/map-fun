var style331 = 'mapbox://styles/yunjieli/cjxmxloim28ou1cnrdf71xugd';
var styleDark = 'mapbox://styles/mapbox/dark-v9';

// global constants, other candidates include , #9ee0f5
var colorStops = ["#000000", "#b9ce67", "#ffc300", "#ff8d19", "#ff5733", "#ff2e00"];
var heightStop = 5000;
var colorActive = "#3cc";
...
mapboxgl.accessToken = 'REDACTED_MAPBOX_PUBLIC_TOKEN';
...
map.on('load', function() {
    ...
    function setLayers() {
        ...
        if (activeCamera === "hexbin") {
            ...
            map.setPaintProperty('points-businesses', 'circle-opacity', .2);
            map.setPaintProperty('grids-3d', 'fill-extrusion-opacity', 0);
            map.setPaintProperty('grid-active', 'fill-extrusion-opacity', 0.1);
            map.setPaintProperty('grid-active', 'fill-extrusion-height', 0);
            map.setPaintProperty('grids', 'fill-extrusion-height', 0);
        };
